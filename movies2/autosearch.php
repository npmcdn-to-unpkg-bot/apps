...
$resultlength = count($xml_result_movies->movies->movie);
...
for($i = 0; $i < $resultlength; $i++) {		
	...
	if(is_object($img)) {
		$poster = $xml_result_movies->movies->movie[$i]->images->image[2]->attributes()->url;
	} else {
		$poster = 'http://cf2.themoviedb.org/assets/2cedc4385eebe/images/no-profile-w92.jpg';
	}
	// $itemlabel = '<img src="'.$poster.'"><h1>'.$xml_result_movies->movies->movie[$i]->name.'</h1><h2>'.$xml_result_movies->movies->movie[$i]->overview.'</h2>';
	
	// $itemlabel = (string)$xml_result_movies->movies->movie[$i]->overview;
	// $pieces = explode(" ", $itemlabel);	
	// $snippet = implode(" ", array_splice($pieces, 0, 12));

	$snippet = (string)$xml_result_movies->movies->movie[$i]->name;
				
	$itemid =  $xml_result_movies->movies->movie[$i]->id;
	
	$items [$snippet] = $itemid;
	
	//laden dauert zu lange
	// $items [(string)$xml_result_movies->movies->movie[$i]->name] = 
		// '<img src="'.$poster.'">
		// <h1>'.$xml_result_movies->movies->movie[$i]->name.'</h1>
		// <h2>'.$xml_result_movies->movies->movie[$i]->overview.'</h2>';
}
